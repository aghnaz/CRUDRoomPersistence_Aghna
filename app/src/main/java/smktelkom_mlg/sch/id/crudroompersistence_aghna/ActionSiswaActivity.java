package smktelkom_mlg.sch.id.crudroompersistence_aghna;
...
public class ActionSiswaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).load(siswaModel.getPathPicture()).into(imgValueProfile);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (data != null) {
            ...
            Glide.with(this).load(imageLibrary.get(0).getPath()).into(imgValueProfile);
        }
    }
    ...
    public void onBtnDeleteClicked() {
        MyApp.db.userDao().deleteUsers(siswaModel);
        startActivity(new Intent(this, MainActivity.class));
        finish();
    }
}
